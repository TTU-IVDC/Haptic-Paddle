...
// determine location and is based on a design from Vanderbilt University
...
double Setpoint, Input, Output;  //Needs to be changed. is for processing stuff so that it compiles
...
void GetLocation()
{
  ...
  absoluteLocation = location + overdrive * sensorRange;
...
//Note: This code does not have some of the modifications made to the sketch labeled "ForProcessing"
//It is included here for completeness only likely won't work as expected in the form below.
//=============================================================================================================
