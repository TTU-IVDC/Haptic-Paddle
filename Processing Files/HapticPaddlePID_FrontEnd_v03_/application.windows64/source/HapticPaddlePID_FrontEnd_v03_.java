...
public class HapticPaddlePID_FrontEnd_v03_ extends PApplet {

/*
This PID Frontend has been modified to run with the haptic paddle built 
at Tennessee Tech University. To use, connect to paddle running
PIDControllerForProcessingFinal.ino via usb. Then change serial port in code below
...
*Fix mixmatch on scrolling speed of gridlines vs data points
 ...
 **********************************************/
int windowWidth = 1350;      // set the size of the //originally 900
int windowHeight = 900;     // form                //originally 600
//int windowWidth = 900;      // set the size of the //originally 900
//int windowHeight = 600;     // form                //originally 600


float InScaleMin = -1500;       // set the Y-Axis Min
float InScaleMax = 1500;    // and Max for both
float OutScaleMin = -255;      // the top and 
float OutScaleMax = 255;    // bottom trends


int windowSpan = 10*1000;    // number of mS into the past you want to display
int refreshRate = 20;      // how often you want the graph to be reDrawn;
...
public void setup()
{
  ...
  myPort = new Serial(this, Serial.list()[0], 115200);                //   Communication with  .. make number = port #
  ...
  controlP5.addButton("Send_To_Arduino",0.0f,10,475,120,20);         //
...
// Scrolling gets off with high refresh rates. Perhaps there is a compounding of a small error?
...
public void serialEvent(Serial myPort)
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "HapticPaddlePID_FrontEnd_v03_" };
    if (passedArgs != null) {
